...
DataDir <- "/Users/rhamilto/Documents/CTR-Manuscripts/2018_Pisapia_DelPozzo/2018_Pisapia_DelPozzo/"
setwd(DataDir)
...
DQA101_lunp <- read.table("StructureAccessibility/DQA101_lunp.txt", header=FALSE, fill=TRUE, comment.char="#")
DQA105_lunp <- read.table("StructureAccessibility/DQA105_lunp.txt", header=FALSE, fill=TRUE, comment.char="#")
colnames(DQA101_lunp) <- c("pos", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10")
colnames(DQA105_lunp) <- c("pos", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10")

DQB105_lunp <- read.table("StructureAccessibility/DQB105_lunp.txt", header=FALSE, fill=TRUE, comment.char="#")
DQB102_lunp <- read.table("StructureAccessibility/DQB102_lunp.txt", header=FALSE, fill=TRUE, comment.char="#")
colnames(DQB105_lunp) <- c("pos", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10")
colnames(DQB102_lunp) <- c("pos", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8", "p9", "p10")
...
plot_DQA_di <- ggplot() + 
               geom_line(data=DQA101_lunp, aes(x=pos, y=p10* scaleFactor), colour="red",  linetype="dashed") +
               geom_line(data=DQA105_lunp, aes(x=pos, y=p10* scaleFactor), colour="blue", linetype="dashed") +
               ...
               scale_y_continuous(name="DQA1*", limits=c(0.0001, 3.5),
                                  sec.axis=sec_axis(~./scaleFactor, name="", breaks=c(seq(0,1,0.2)))) +
               xlab("") 

plot_DQB_di <- ggplot() + 
               geom_line(data=DQB105_lunp, aes(x=pos, y=p10* scaleFactor), colour="red",  linetype="dashed") +
               geom_line(data=DQB102_lunp, aes(x=pos, y=p10* scaleFactor), colour="blue", linetype="dashed") +
               ...
               scale_y_continuous(name="DQB1*", limits=c(0.0001, 3.5),
                                  sec.axis=sec_axis(~./scaleFactor, name="Structure Accessibility", breaks=c(seq(0,1,0.2)))) +
               xlab("")
